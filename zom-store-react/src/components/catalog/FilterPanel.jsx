...
function FilterPanel() {
    ...
    if (filtersLoading) {
        return (
            <div className="flex items-center gap-2 px-4 py-2 mb-4 text-sm font-semibold text-white rounded-md bg-primary-400">
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                Filters
                {activeFilterCount > 0 && (
                    <span className="flex items-center justify-center w-5 h-5 text-xs font-bold text-white rounded-full bg-primary-700">
                        {activeFilterCount}
                    </span>
                )}
            </button>
                ...
                <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                    <div className="w-[90%] sm:w-[420px] bg-white rounded-xl shadow-md p-6 animate-fadeIn relative max-h-[80vh] overflow-y-auto">
                        ...
                        <div className="flex justify-between gap-3 mt-6">
                            ...
                            <button
                                className="flex-1 px-4 py-2 text-sm font-semibold text-white transition rounded-lg bg-primary-500 hover:bg-primary-600"
