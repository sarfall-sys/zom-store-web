...
function ProductGrid() {
  ...
  const { loadProducts, clearProducts, products, loading, error } = useProducts();
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <BiLoader className="text-lavender-600 animate-spin" size={48} />
      </div>
    );
  }
  ...
  return (
    <div className="w-full p-6 bg-white rounded-lg shadow-sm">
      ...
      {brand && (
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-lavender-700">
